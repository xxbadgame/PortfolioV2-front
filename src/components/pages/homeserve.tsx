        ...
        <div>
                ...
                <div className="md:w-[80%] flex justify-center">
                    <div className="md:w-[60%] p-[10px]">
                        ...
                        <p className="text-2xl">
                            One-year apprenticeship at Homeserve, working on product
                            flow and CRM, developing a new product validation method and data quality process.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="text-left flex flex-col gap-32">
                <div>
                    <div className=" sticky top-0 z-0 p-12 lg:w-[40%]">
                        ...
                        <h3 className="text-3xl font-bold mb-6">Apprenticeship at Homeserve</h3>
                        <p className="text-neutral-400 text-lg">
                            A one-year apprenticeship at Homeserve, where I gained practical
                            experience in various business operations and technical development.
                        </p>
                    </div>
                ...
                <div className="relative md:flex">
                    <div className="sticky top-0 self-start md:w-[40%] p-12 z-0">
                        ...
                        <h3 className="text-3xl font-bold mb-6">Work on Product</h3>
                        <p>
                            I focused on optimizing the product flow and customer relationship management (CRM) systems, 
                            ensuring smoother processes and improved customer interactions.
                        </p>
                    </div>
                ...
                <div>
                    <div className="sticky top-0 z-0 p-12 lg:w-[40%]">
                        ...
                        <h3 className="text-3xl font-bold mb-6">Data Quality</h3>
                        <p>
                            I developed a new product validation method and enhanced
                            data quality processes to improve accuracy and efficiency within the company.
                        </p>
                    </div>
                    <div className="h-[100vh] relative z-10">
                        <img 
            ...
            <div className="lg:w-[40%] text-left p-12 mt-24">
                ...
                <p className="text-2xl md:text-4xl">
                    In conclusion, my apprenticeship at Homeserve provided valuable experience 
                    in product flow optimization, CRM systems, and data quality management. 
                    I contributed to the development of efficient processes that improved 
                    both product validation and overall operational performance.
                </p>
            </div>
