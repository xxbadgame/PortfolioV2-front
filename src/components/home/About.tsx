        ...
        <div>
            ...
            <div className="flex md:flex-row flex-col justify-between">
                <div className="w-[70%] flex">
                    ...
                    <div className="border-t flex flex-col w-[70%] p-12 md:p-16 lg:p-32 gap-24 text-left">
                        <div>
                ...
                <div className="sticky top-0 md:border-l md:border-t h-[50vh] md:h-[100vh] w-[30%]">
                    <div className="text-left md:p-2 lg:p-16 md:p-8">
